...
///////////////////CHOOSE CHAIR EVENTS//////////////////////
    ...
    $(document).on('click', '.cinema-seat .single, .cinema-seat .couple',function() {
...
//////////////////FINAL EVENTS/////////////////////////////
	...
	$(document).on('click', '#payment-next', function(){
        ...
        //window.location = url;
		if($('.check_terms_condition:checked').length == 0 || $('.payment_method_radio:checked').length == 0 || $('.check_terms_condition_1:checked').length == 0 ){
        ...
        getPage(BASE_URL+'redirect-onepay.html', 'POST', params, function(){
...
/////////////////////////////SHOW POPUP EVENTS AT FOOOTER//////////////////////////
	$('.bottom-nav-icon li a, .nav-icon-wrap li a, .copyright h2 a').click(function(e){
			e.preventDefault();
			var name = $(this).attr('data-name');
